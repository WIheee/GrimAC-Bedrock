...
const THRESHOLDS = {
    // 钻石：稀有
    diamond: [6, 8, 10, 12, 16, 20, 24],
    
    // 远古残骸：稀有
    ancient_debris: [3, 4, 5, 6, 8, 10, 12],
    
    // 绿宝石：稀有
    emerald: [3, 4, 5, 6, 8, 10, 12],
    
    // 金矿：普通
    gold: [10, 13, 16, 20, 26, 32, 40, 48],
    
    // 铁矿：常见
    iron: [10, 13, 20, 32, 48, 64, 80, 96],
    
    // 煤矿：烂大街
    coal: [10, 14, 32, 64, 80, 96, 112, 128],
    
    // 铜矿：常见
    copper: [10, 14, 24, 48, 64, 80, 96],
    
    // 红石：常见
    redstone: [10, 14, 20, 32, 48, 64, 80, 96],
    
    // 青金石：常见
    lapis: [10, 14, 20, 32, 48, 64, 80, 96],
    
    // 下界石英：常见
    quartz: [10, 14, 18, 24, 44, 64, 80, 96],
    
    // 下界金矿：遍地都是
    nether_gold: [12, 18, 30, 48, 64, 80, 96]
}
// 矿物映射（事件 ID → 统计类型）
const ORE_MAPPING = {
    // 钻石
